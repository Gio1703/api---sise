...
const horariosService = __importStar(require("../services/horariosServices"));
...
const listarHorarios = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield horariosService.listarHorarios();
...
const obtenerHorario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { id } = req.params;
        const response = yield horariosService.obtenerHorario(Number(id));
        res.json(responseModel_1.ResponseModel.success(response));
    }
    catch (error) {
        console.error(error.message);
...
const insertarHorario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { error } = horarioSchema_1.horarioCrearSchema.validate(req.body);
    if (error) {
    ...
    try {
        const response = yield horariosService.insertarHorario(req.body);
        res.json(responseModel_1.ResponseModel.success(response));
    }
    catch (error) {
        console.error(error.message);
...
const modificarHorario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { id } = req.params;
        const response = yield horariosService.modificarHorario(Number(id), req.body);
        res.json(responseModel_1.ResponseModel.success(response));
    }
    catch (error) {
        console.error(error.message);
...
const eliminarHorario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { id } = req.params;
        const response = yield horariosService.eliminarHorario(Number(id));
        res.json(responseModel_1.ResponseModel.success(response));
    }
    catch (error) {
        console.error(error.message);
